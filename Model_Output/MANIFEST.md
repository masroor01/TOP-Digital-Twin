...
| `15b_Tree_Model_Comparison.py` | `table_tree_model_comparison*.csv`, `fig_tree_model_comparison.png` | 2026-07-27 (14:42) | 🟡 | Run before the coverage filter and potato zone fix that same day — reflects the old, unfiltered panel |
| `15c_LSTM_Transformer_Comparison.py` | `table_lstm_transformer_comparison*.csv`, `fig_lstm_transformer_comparison.png` | 2026-07-27 (16:23) | 🟡 | Same as above — pre-coverage-filter |
...
- Tree/LSTM-Transformer comparisons (15b/15c) — need a re-run on the current panel if their conclusions are going to be cited
