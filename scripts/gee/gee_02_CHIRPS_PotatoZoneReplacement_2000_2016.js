// ============================================================
// GEE Script — CHIRPS Pentad Rainfall, PRE-2017 HISTORY
...
// rationale. CHIRPS itself goes back to 1981, but 2000-01-01 is used
// here to match ERA5/MODIS's shared floor -- no baseline-phase layer
// needs rainfall further back than that for these 3 zones.
//
...
//         One CSV per zone: {zone_id}_CHIRPS_full_2000_2016.csv
// ============================================================
...
zoneList.forEach(function(z) {
  ...
  Export.table.toDrive({
    collection   : pentads,
    description  : z.id + '_CHIRPS_full_2000_2016',
    folder       : FOLDER,
    fileNamePrefix: z.id + '_CHIRPS_full_2000_2016',
    fileFormat   : 'CSV',
...
print('CHIRPS potato-zone replacement, historical (2000-2016): ' + zoneList.length + ' export tasks queued.');
