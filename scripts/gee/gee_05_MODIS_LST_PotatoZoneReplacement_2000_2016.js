// ============================================================
// GEE Script — MODIS 8-Day Land Surface Temperature, PRE-2017 HISTORY
...
// rationale. MOD11A2 (Terra) starts 2000-02-18, same as MOD13Q1 above.
//
...
//         One CSV per zone: {zone_id}_MODIS_LST_full_2000_2016.csv
// ============================================================
...
zoneList.forEach(function(z) {
  ...
  Export.table.toDrive({
    ...
    description  : z.id + '_MODIS_LST_full_2000_2016',
    folder       : FOLDER,
    fileNamePrefix: z.id + '_MODIS_LST_full_2000_2016',
    fileFormat   : 'CSV',
...
print('MODIS LST potato-zone replacement (Terra MOD11A2), historical (2000-2016): ' + zoneList.length + ' export tasks queued.');
