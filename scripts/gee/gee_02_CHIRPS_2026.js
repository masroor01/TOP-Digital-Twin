// ============================================================
// GEE Script 02 — CHIRPS Pentad Rainfall 2026
...
//         One CSV per zone: {zone_id}_CHIRPS_2026.csv
//
...
// available, bump END forward before running. CHIRPS PENTAD also
// tends to lag a few weeks behind real-time — check the collection's
// latest available date in the GEE catalog if recent pentads are missing.
// ============================================================
...
zoneList.forEach(function(z) {
  ...
  Export.table.toDrive({
    collection   : pentads,
    description  : z.id + '_CHIRPS_2026',
    folder       : FOLDER,
    fileNamePrefix: z.id + '_CHIRPS_2026',
    fileFormat   : 'CSV',
...
print('CHIRPS 2026: ' + zoneList.length + ' export tasks queued.');
print('Date range: ' + START + ' to ' + END);
print('~30 pentads x 17 zones expected for a Jan-Jul window.');
