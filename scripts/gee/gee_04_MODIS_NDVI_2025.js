// ============================================================
// GEE Script 04 — MODIS 16-Day NDVI/EVI 2025
...
//         One CSV per zone: {zone_id}_MODIS_NDVI_2025.csv
// ============================================================
...
zoneList.forEach(function(z) {
  ...
  Export.table.toDrive({
    ...
    description  : z.id + '_MODIS_NDVI_2025',
    folder       : FOLDER,
    fileNamePrefix: z.id + '_MODIS_NDVI_2025',
    fileFormat   : 'CSV',
...
print('MODIS NDVI 2025 (Terra + Aqua): ' + zoneList.length + ' export tasks queued.');
print('Expected: ~46 composites per zone (23 Terra + 23 Aqua, 16-day each, offset 8 days)');
