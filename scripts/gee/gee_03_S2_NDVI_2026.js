// ============================================================
// GEE Script 03 — Sentinel-2 NDVI/EVI Bimonthly Composites 2026
...
//   → up to 24 composites per zone per year (windows after the data
//     cutoff below will simply come back empty and get filtered out)
...
//         One CSV per zone: {zone_id}_S2_NDVI_2026.csv
//
// NOTE: collection is filtered to DATA_START/DATA_END below (matching
// the 2026-07-24 price/arrivals data you already have). If you're
// running this later with more 2026 weeks available, extend DATA_END
// forward before running.
// ============================================================

var YEAR  = 2026;
var DATA_START = '2026-01-01';
var DATA_END   = '2026-07-25';  // exclusive — covers through 2026-07-24
...
// ──────────────────────────────────────────────────────────────
// Build 15-day composite windows for 2026 (2026 is not a leap year)
// Windows: 1-15 and 16-end for each month
// ──────────────────────────────────────────────────────────────
var windows = [];
var monthDays = [31,28,31,30,31,30,31,31,30,31,30,31]; // 2026 is not leap year
for (var m = 1; m <= 12; m++) {
...
// Load S2 SR Harmonized collection for the available 2026 window
// (later composite windows above will just come back empty and get
// filtered out below — harmless, just slightly wasted computation)
...
zoneList.forEach(function(z) {
  ...
  Export.table.toDrive({
    ...
    description  : z.id + '_S2_NDVI_2026',
    folder       : FOLDER,
    fileNamePrefix: z.id + '_S2_NDVI_2026',
    fileFormat   : 'CSV',
...
print('S2 NDVI 2026: ' + zoneList.length + ' export tasks queued.');
print('Data window: ' + DATA_START + ' to ' + DATA_END);
print('Up to 24 composites per zone generated; only Jan-Jul windows will have data.');
