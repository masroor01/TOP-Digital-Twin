// ============================================================
// GEE Script 01 — ERA5-Land Daily Temperature Topup 2026
...
//         One CSV per zone: {zone_id}_ERA5topup_2026.csv
//
...
// available, bump END forward (e.g. to today's date) before running.
// ============================================================
...
zoneList.forEach(function(z) {
  ...
  Export.table.toDrive({
    collection  : daily,
    description : z.id + '_ERA5topup_2026',
    folder      : FOLDER,
    fileNamePrefix: z.id + '_ERA5topup_2026',
    fileFormat  : 'CSV',
...
print('ERA5 topup 2026: ' + zoneList.length + ' export tasks queued.');
