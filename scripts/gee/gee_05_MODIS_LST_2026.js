// ============================================================
// GEE Script 05 — MODIS 8-Day Land Surface Temperature 2026
...
//         One CSV per zone: {zone_id}_MODIS_LST_2026.csv
//
...
// available, bump END forward before running.
// ============================================================
...
zoneList.forEach(function(z) {
  ...
  Export.table.toDrive({
    ...
    description  : z.id + '_MODIS_LST_2026',
    folder       : FOLDER,
    fileNamePrefix: z.id + '_MODIS_LST_2026',
    fileFormat   : 'CSV',
...
print('MODIS LST 2026 (Terra MOD11A2): ' + zoneList.length + ' export tasks queued.');
print('Date range: ' + START + ' to ' + END);
print('Expected: fewer than 46 composites per zone for a Jan-Jul window (8-day, cloud-filtered).');
